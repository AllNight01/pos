...
const sections = [
  {
    ...
    href: "/",
    cta: "ไปหน้าขายสินค้า",
    body: "หน้าแรกของระบบคือหน้าขายสินค้า ใช้สำหรับเลือกสินค้า เพิ่มลงตะกร้า ชำระเงินสดหรือเงินโอน และบันทึกยอดขายรายวัน",
  },
  {
    id: "session",
    title: "เปิดรอบขาย",
    ...
    cta: "ไปหน้าคลังร้าน",
    body: "ไปที่เมนูสต๊อก > คลังร้าน แล้วกดเปิดรอบขายใหม่ ระบุชื่อรอบตามงานจริง เช่น รอบตลาดศุกร์-เสาร์-อาทิตย์ รอบนี้จะใช้เก็บ movement ของสต๊อกจนกว่าจะปิดรอบ",
  },
  {
    id: "warehouse",
    ...
    href: "/stock/warehouse",
    cta: "รับเข้าคลังร้าน",
    body: "เมื่อพนักงานรับของมาจากคลังใหญ่ ให้กรอกยอดสุทธิที่รับเข้าจริงในหน้าคลังร้าน ระบบจะถือว่าของนี้เข้าสู่คลังร้านทันที โดยไม่ต้อง track คลังใหญ่แยกในระบบ",
  },
  {
    id: "storefront",
    ...
    cta: "ไปหน้าหน้าร้าน",
    body: "ที่เมนูหน้าร้าน พนักงานสามารถเบิกจากคลังร้านไปหน้าร้านได้หลายครั้งภายในวันเดียว ระบบจะบันทึกเป็นรายการ movement ทีละรอบ และรวมยอดคงเหลือให้โดยอัตโนมัติ",
  },
  {
    id: "comparison",
    ...
    body: "หน้าเปรียบเทียบใช้ตรวจสอบต่อสินค้า ทั้งยอดยกมาคลัง รับเข้า เบิกไปหน้าร้าน คลังคงเหลือ หน้าร้านคงเหลือ ยอดขายรายวัน หน้าร้านควรเหลือ นับจริง และส่วนต่างล่าสุด",
  },
  {
    id: "closeout",
    title: "ปิดรอบขาย",
    ...
    href: "/stock/closeout",
    cta: "ไปหน้าปิดรอบ",
    body: "เมื่อขายจบ ให้ไปที่หน้าปิดรอบ นับหน้าร้านจริง บันทึกยอดนับ แล้วคืนของกลับเข้าคลังร้าน หลังตรวจสอบครบแล้วจึงกดปิดรอบขาย",
  },
  {
    id: "products",
    ...
    body: "หน้า สินค้า ใช้สำหรับอัปโหลดรูปสินค้าใหม่ เปลี่ยนรูปเดิม และบันทึก URL ของรูปลง Google Sheet โดยตรง ระบบจะเก็บไฟล์ไว้ที่ Vercel Blob จึงเหมาะกับการ deploy บน Vercel โดยไม่ต้องมีฐานข้อมูลแยก",
  },
  {
    id: "cash",
    title: "นับเงินรายวัน",
    ...
    href: "/cash-count",
    cta: "ไปหน้านับเงิน",
    body: "หน้า นับเงิน ยังคงเป็นรายวัน กรอกเงินทอนตั้งต้น นับเงินจริง และกรอกยอดโอนแบบ manual-first ได้ โดยระบบจะแสดงยอดขายเงินสดและช่วยเสนอค่ายอดโอนจาก daily sales เป็นตัวช่วย",
  },
  {
    id: "summary",
    title: "สรุปยอดรายวัน",
    ...
    href: "/summary",
    cta: "ไปหน้าสรุปยอด",
    body: "หน้า สรุปยอด ใช้ดูภาพรวมยอดขายของวันเดียว ทั้งยอดรวม เงินสด เงินโอน รายการสินค้า และรายการบิล เหมาะสำหรับตรวจสอบปิดวันด้านการเงิน",
  },
];
        ...
        <main className="space-y-5">
          <section className="rounded-[32px] border border-white/[0.06] bg-linear-to-br from-white/[0.04] via-white/[0.03] to-white/[0.01] p-6 shadow-2xl shadow-black/30">
            ...
            <p className="mt-4 max-w-3xl text-base leading-8 text-slate-300">
              คู่มือนี้อธิบาย flow ใหม่ของระบบ
              โดยแต่ละหัวข้อจะบอกชัดว่าอยู่ตรงไหนในเมนูด้านซ้ายและมีปุ่มลัดให้กดเข้าใช้งานหน้าจริงได้ทันที
            </p>
          </section>
